...
class GameMod
{
    ...
    public GameMod()
    {
        ...
        Tetrimino firstTetrimino = new Tetrimino(); 
        Tetrimino currentTetrimino = new Tetrimino(firstTetrimino.Shape, firstTetrimino.Color, firstTetrimino.X, firstTetrimino.Y); 
            ...
            if (!isPaused)
            {
                ...
                if (timer >= dropTime)
                {
                    ...
                    if (locked)
                    {
                        ...
                        {
                            currentTetrimino = new Tetrimino(firstTetrimino.Shape,firstTetrimino.Color,firstTetrimino.X,firstTetrimino.Y);                           
                        }
                    }
